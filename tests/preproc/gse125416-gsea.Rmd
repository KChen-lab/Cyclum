...
## Scale
```{r}
obj <- ScaleData(obj, features = rownames(obj), vars.to.regress = c("nCount_RNA", "percent.mt"))
```
...
```{r}
saveRDS(obj, "~/Documents/data/hESC-droplet/GSE125416/GSM357649-regress.RDS")
```

```{r}
obj <- readRDS("~/Documents/data/hESC-droplet/GSE125416/GSM357649-regular.RDS")
```

```{r}
source("../utils/hdfrw.R")
mat2hdf(as.matrix(obj@assays$RNA@scale.data), "~/Documents/data/hESC-droplet/GSE125416/GSM357649-regress.h5")
```
