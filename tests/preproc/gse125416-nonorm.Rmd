...
```{r}
saveRDS(obj, "~/Documents/data/hESC-droplet/GSE125416/GSM357649-nonorm.RDS")
```

```{r}
source("../utils/gsea.R")
mat2cls(as.matrix(obj@reductions$pca@cell.embeddings), "~/Documents/data/hESC-droplet/GSE125416/GSM357649-nonorm-pca.cls")
```

```{r}
source("../utils/hdfrw.R")
mat2hdf(as.matrix(obj@assays$RNA@scale.data), "~/Documents/data/hESC-droplet/GSE125416/GSM357649-nonorm.h5")
```
