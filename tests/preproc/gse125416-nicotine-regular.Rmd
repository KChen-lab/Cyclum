...
```{r}
library(Seurat)
filepath = "/home/shaoheng/Documents/data/hESC-droplet/GSE125416/GSM3573650_N_filtered_gene_bc_matrices_h5.h5"
obj = CreateSeuratObject(Read10X_h5(filepath), project='nicotine')
obj
```
...
```{r}
source("../utils/gsea.R")
mat2cls(as.matrix(obj@reductions$pca@cell.embeddings), "~/Documents/data/hESC-droplet/GSE125416/GSM357650-regular-pca.cls")
```

```{r}
source("../utils/hdfrw.R")
mat2hdf(as.matrix(obj@assays$RNA@scale.data), "~/Documents/data/hESC-droplet/GSE125416/GSM357650-regular.h5")
```
